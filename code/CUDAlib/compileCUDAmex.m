...
if(nargin > 0)
    ...
    compileCUDAlibMex = @(fName) system(['cd ' objDir '; ' CUDAdirectory '/bin/nvcc -c -shared -m64 --expt-relaxed-constexpr --gpu-architecture ' GPUArchitecture ' ' extraArgs ' -I' sourceDir ' -I' CUDASamplesdirectory '/common/inc/  -I' MATLABdirectory 'extern/include ' sourceDir '/' fName '.cu' ]); %mv ' fName '.o ' objDir '/' fName '.o'
